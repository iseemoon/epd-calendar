...
#define MDNS_HOST_NAME "epd"

#define AP_SSID         "ePaper-Station"     // 设置AP热点名称
#define AP_PSWD         "88888888"           // 设置AP热点密码
#define AP_DEF_CHANNEL  11
...
static void initialise_mdns(void)
{
    ...
    ESP_ERROR_CHECK(mdns_service_add("EPD-WebServer", "_http", "_tcp", 80, serviceTxtData,
...
void wifi_init_softap(void)
{
    ...
    ESP_LOGI(TAG, "wifi_init_softap finished. SSID:%s password:%s channel:%d",
             AP_SSID, AP_PSWD, AP_DEF_CHANNEL);
}
